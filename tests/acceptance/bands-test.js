...
module('Acceptance | Bands', function (hooks) {
  ...
  test('Sort songs in various ways', async function (assert) {
    ...
    assert.dom('[data-test-rr=song-list-item]:first-child').hasText('Elephants', 'The last song is the one that comes first in the alphabet');
    assert.dom('[data-test-rr=song-list-item]:last-child').hasText('Spinning in Daffodils', 'The first song is the one that comes last in the alphabet');
